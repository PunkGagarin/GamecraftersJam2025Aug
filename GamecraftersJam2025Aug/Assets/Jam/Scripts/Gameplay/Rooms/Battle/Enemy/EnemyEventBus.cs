...
namespace Jam.Scripts.Gameplay.Battle.Enemy
{
    public class EnemyEventBus
    {
        ...
        public event Action<EnemyModel, Guid> OnStartEnemyDeath = delegate { };
        public event Action<EnemyModel, Guid> OnEndEnemyDeath = delegate { };
        ...
        public void InvokeStartDeath(EnemyModel unit, Guid guid) => OnStartEnemyDeath.Invoke(unit, guid);
        public void InvokeEndEnemyDeath(EnemyModel unit, Guid guid) => OnEndEnemyDeath.Invoke(unit, guid);
